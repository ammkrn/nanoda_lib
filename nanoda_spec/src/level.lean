...
| owise (l r : Level) : isZeroLit l ff
                        -> isZeroLit r ff
                        -> isSucc l ff
                        -> isSucc r ff
                        -> combining l r (m l r)
...
| max (l r l' r' x : Level) : simplify l l'
                                    -> simplify r r'
                                    -> combining l' r' x
                                    -> simplify (m l r) x
...
| imaxsucc (l r l' r' x : Level) : simplify r (s r')
                                  -> simplify l l'
                                  -> combining l' (s r') x
                                  -> simplify (im l r) x

| imaxowise (l r l' r' : Level) : simplify r r'
                                    -> isZeroLit r' ff
                                    -> isSucc r' ff
                                    -> simplify l l'
...
| stepS (l : Level) (ls : list Level) : paramsDefined l ls
                                            -> paramsDefined (s l) ls

| stepM (l r : Level) (ls : list Level) : paramsDefined l ls                                          
                                             -> paramsDefined r ls
                                             -> paramsDefined (m l r) ls

| stepIm (l r : Level) (ls : list Level) : paramsDefined l ls                                          
                                              -> paramsDefined r ls
                                              -> paramsDefined (im l r) ls
| baseParam (n : Name) 
             (hd : Level) 
             (tl : list Level) 
             : paramsDefined (p n) (p n :: tl)

| stepParam (n : Name)
             (hd : Level)
             (tl : list Level) : paramsDefined (p n) tl
...
| step (hd : Level) (tl dec_ups : list Level) : paramsDefinedMany tl dec_ups
...
| mkSucc (pred pred' : Level) (ks vs : list Level) : subst pred ks vs pred'
                                                     -> subst (s pred) ks vs (s pred')

| mkMax (l r l' r' : Level) (ks vs : list Level) : subst l ks vs l'
                                                   -> subst r ks vs r'
                                                   -> subst (m l r) ks vs (m l' r')

| mkImax (l r l' r' : Level) (ks vs : list Level) : subst l ks vs l'
                                                   -> subst r ks vs r'
...
| s_any (l r : Level) (l_h r_h : nat) (b : bool) : leqCore l r (nat.succ l_h) (r_h) b
                                                    -> leqCore (s l) r l_h r_h b
| any_s (l r : Level) (l_h r_h : nat) (b : bool) : leqCore l r l_h (nat.succ r_h) b
...
| mk (l r l' r' : Level) (b : bool) : simplify l l' 
                                      -> simplify r r'
                                      -> leqCore l' r' 0 0 b
                                      -> leq l r b
...
| mk (l r : Level) (b1 b2 : bool) : leq l r b1 
                                    -> leq r l b2 
                                    -> eqAntisymm l r (b1 && b2)


inductive geq : Level -> Level -> bool -> Prop
| mk (l r : Level) (b1 b2 : bool) : eqAntisymm l r b1
                                    -> leq r l b2 
                                    -> geq l r (b1 || b2)
